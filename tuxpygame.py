...
racer = pygame.transform.scale(pygame.image.load("tuxiAfD.xfc").convert_alpha(), (100, 100))
...
BG = pygame.transform.scale(pygame.image.load('rennstrecke.jpg'), (1920, 1080))
